...
export const manualShows: Show[] = [
  ...
  {
    id: "larson-majura-2024-08-04",
    artistId: "larson-majura",
    artistName: "Travis Larson & Jen Majura",
    date: "2024-08-04",
    venue: "Mr. Beery's Pub",
    city: "Bethpage",
    source: "manual",
    notes: "Opened up for Ad Astra.",
  },
  {
    id: "ad-astra-2024-08-04",
    artistId: "ad-astra",
    artistName: "Ad Astra",
    date: "2024-08-04",
    venue: "Mr. Beery's Pub",
    city: "Bethpage",
    source: "manual",
    notes: "Travis Larson & Jen Majura opening.",
  },
];
